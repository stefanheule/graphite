...
// -- ## endfor
    ...
    dirty |= sync_helper_uint8_t(CONFIG_COLOR_BOTTOM_WIDGETS, iter, &config_color_bottom_widgets);
    dirty |= sync_helper_uint8_t(CONFIG_COLOR_BACKGROUND, iter, &config_color_background);
    dirty |= sync_helper_uint8_t(CONFIG_COLOR_TOP_WIDGETS, iter, &config_color_top_widgets);
...
// -- ## endfor
    ...
    read_config_uint8_t(CONFIG_COLOR_BOTTOM_WIDGETS, &config_color_bottom_widgets);
    read_config_uint8_t(CONFIG_COLOR_BACKGROUND, &config_color_background);
    read_config_uint8_t(CONFIG_COLOR_TOP_WIDGETS, &config_color_top_widgets);
