...
// -- ## endfor
    ...
    if (has_widget([33])) sendTzUpdate(1);
    if (has_widget([34])) sendTzUpdate(2);
    if (has_widget([35])) sendTzUpdate(3);
    if (has_widget([36])) sendTzUpdate(4);
    if (has_widget([37])) sendTzUpdate(5);
// -- end autogen
