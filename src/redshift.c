...
uint8_t config_color_bottom_widgets = GColorWhiteARGB8;
uint8_t config_color_background = GColorBlackARGB8;
uint8_t config_color_top_widgets = GColorBlackARGB8;
...
uint8_t config_widget_1 = 2;
uint8_t config_widget_2 = 1;
uint8_t config_widget_3 = 3;
uint8_t config_widget_4 = 12;
